...
# List of all symptoms (human-readable)
symptoms = [
    ...
    'dischromic__patches','watering_from_eyes','increased_appetite','polyuria','family_history','mucoid_sputum','rusty_sputum',
...
if st.button("Predict Disease"):
    if not selected_symptoms:
        ...
        # Preprocess input: create binary input vector
        ...
        prediction_proba = model.predict_proba(input_df).max()
